...
public class TwitterParser implements SocialParser {
    ...
    private static void parseUsers() {
        try {
            ...
            List<String> nicknames = Files.lines(Paths.get("input/vk.txt"))
//                    .filter(l -> l.startsWith("vk"))
            ...
            Set<TwitterUser> users = new HashSet<>(twitterParser.getSafeUsers(nicknames));
            ...
            PrintWriter pw = new PrintWriter(new BufferedWriter(new FileWriter("input/vk2.txt", true)));
